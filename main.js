...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"footer\": () => (/* binding */ footer)\n/* harmony export */ });\nfunction footer(){\n    const footer = document.createElement('div')\n    footer.classList.add('footer')\n    const logo = document.createElement('img')\n    logo.src = 'https://images.fastcompany.net/image/upload/w_1280,f_auto,q_auto,fl_lossy/w_596,c_limit,q_auto:best,f_auto/fc/3034007-inline-i-applelogo.jpg'\n    logo.alt = 'Logo Here'\n    const mid = document.createElement('div')\n    const copyright = document.createElement('h3')\n    copyright.textContent = 'Copyright 2021.'\n    const rights = document.createElement('h3')\n    rights.textContent = 'All rights reserved.'\n    mid.append(copyright, rights)\n    const privacy = document.createElement('h3')\n    privacy.textContent = 'Privacy policy and legal notice'\n    const contact = document.createElement('h3')\n    contact.textContent = 'contact'\n    const bot = document.createElement('div')\n    bot.append(privacy, contact)\n    footer.append(logo, mid, bot)\n    return footer\n}\n\n\n\n//# sourceURL=webpack://restaurant_page/./src/footer.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"home\": () => (/* binding */ home)\n/* harmony export */ });\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main */ \"./src/main.js\");\n/* harmony import */ var _footer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./footer */ \"./src/footer.js\");\n\n\nfunction home(){\n    const container = document.createElement('div')\n    container.classList.add('container')\n    const header = document.createElement('div')\n    const left = document.createElement('div')\n    left.classList.add('left')\n    right.classList.add('right')\n    const right = document.createElement('div')\n    header.classList.add('header')\n    const title = document.createElement('h1')\n    title.textContent = \"Boki's Restaurant\"\n    const subtitle = document.createElement('h3')\n    subtitle.textContent = 'Established 1888'\n    left.append(title, subtitle)\n    const home = document.createElement('button')\n    home.textContent = \"Home\";\n    const about = document.createElement('button')\n    about.textContent = \"About\";\n    const contact = document.createElement('button')\n    contact.textContent = \"Contact\";\n    left.append(home, about, contact)\n    header.append(left, right)\n    container.append(header, (0,_main__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(), (0,_footer__WEBPACK_IMPORTED_MODULE_1__[\"default\"])())\n    return container\n}\n\n\n\n//# sourceURL=webpack://restaurant_page/./src/heading.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"main\": () => (/* binding */ main)\n/* harmony export */ });\nfunction main(){\n   const main = document.createElement('div')\n   main.classList.add('main');\n   const request = document.createElement('h1')\n   request.textContent = 'Booking requests' \n   const content = document.createElement('div')\n   content.classList.add('content')\n   const text = document.createElement('h4')\n   text.textContent = \"Our calendar has a permanent update system, it is updated daily with new available dates. If there are places available at the time of receipt, we will send you a confirmation of your booking.\"\n   const section = document.createElement('div');\n   const menu = document.createElement('h3')\n   menu.textContent = 'MENU'\n   const guest = document.createElement('div')\n   const guestLogo = document.createElement('h3')\n   guestLogo.textContent = 'Logo here'\n   const guests = document.createElement('h3')\n   guests.textContent = 'Guests'\n   const book = document.createElement('button')\n   book.textContent = 'Book'\n   guest.append(guestLogo, guests,)\n   book.classList.add('book')\n   section.append(menu, guest)\n    content.append(text, section)\n    main.append(request, content)\n    return main\n}\n\n\n\n//# sourceURL=webpack://restaurant_page/./src/main.js?");
